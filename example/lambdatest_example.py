...
def main():
    ...
    test_source_loader = load_images(train_source_file_path, batch_size=batch_size, resize_size=256, is_train=False, crop_size=224, worker_init=gen_init_fn(GLOBAL_SEED), prefix=args.prefix)
